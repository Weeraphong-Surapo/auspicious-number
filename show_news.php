      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <h2>บทความเรื่อง <?php echo $_GET['title'];?></h2> <br>
                <?php
                    include "connect.php";
                    $query = $conn->query("SELECT * FROM tb_news WHERE head = '$_GET[title]'");
          ...
          <div class="col-lg-12 w-100">
            ...
            $sql = "SELECT * FROM tb_phone WHERE category = '$_GET[ct]' ORDER BY category_price DESC";

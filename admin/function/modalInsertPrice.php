...
?>
    <!-- Modal -->
    <div class="modal fade" id="modalInsertPrice" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content card card-body">
                <div class="modal-body">
                    ...
                    <form action="" id="formInsertPrice">
                        <div class="mb-3">
                            <label for="" style="font-size: 12px;">ราคาไม่เกิน</label>
                            <input type="text" class="form-control" placeholder="ช่วงราคา" name="category_price" id="category_price">
                        </div>
